...
public class DrawPane extends BorderPane {
    ...
    private final Font myFont = Font.font("Calibri", FontWeight.BOLD, fontsize); private final int border = 20;
    // instance variables
    ...
    public DrawPane(Message message) {
        ...
        setBackground(new Background(new BackgroundFill(Color.WHITE, null, null))); textfield = new Text("unknown");
