...
public class RightSliderPane extends VBox {
	...
	public RightSliderPane(MyScene scene) {
	...
	public void setRandomColor() {
		...
		scene.setRightColor(randomNum1, randomNum2, randomNum3);
	...
	private class SliderListener implements ChangeListener<Number> {
		...
		public void changed(ObservableValue<? extends Number> observable, Number oldValue, Number newValue) {
			...
			scene.setRightColor((int) RED_VALUE, (int) GREEN_VALUE, (int) BLUE_VALUE);
